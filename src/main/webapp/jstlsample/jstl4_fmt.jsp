...
<fmt:formatDate value="${now }" type="both" dateStyle="short" pattern="yy-MM-dd" />
<fmt:formatDate value="${now }" type="both" dateStyle="short" pattern="yy-MM-dd [a] hh:mm:ss" />
...
<fmt:formatDate value="${now }" type="both" dateStyle="long" pattern="YY-MM-dd" />
...
<fmt:formatDate value="${now }" type="both" dateStyle="short" pattern="yy-MM-dd [a] hh:mm:ss" /> <br />
<fmt:formatDate value="${now }" type="both" dateStyle="short"  /> <br />
<fmt:formatDate value="${now }" type="both" dateStyle="medium"  /> <br />
<fmt:formatDate value="${now }" type="both" dateStyle="long"  /> <br />
<fmt:formatDate value="${now }" type="both" dateStyle="full"  /> <br />
